...
class DesiredUser(BaseModel):
    ...
    def get_diff_fields(cls):
        return {'display_name': 'displayName', 'external_id': 'externalId', 'active': 'active'}
        ...
        if not len(dbr_users):
            ...
            for u in dbr_users:
                ...
                if operations:
                    ...
                    total_differences.append(UserDiff(desired=desired_user, actual=u, operations=operations))
